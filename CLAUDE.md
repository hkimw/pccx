...
| v002 | [`hwkim-dev/NPU-FPGA-Transformer-Accelerator-KV260`](https://github.com/hwkim-dev/NPU-FPGA-Transformer-Accelerator-KV260) | 활성. CI 시점에 `codes/v002/` 로 `git clone` |
...
- **퍼블리시**: `https://hwkim-dev.github.io/pccx-FPGA-NPU-LLM-kv260/` (`main` push 시 자동 배포).
...
`docs/v002/RTL/*.rst` 는 외부 레포 `hwkim-dev/NPU-FPGA-Transformer-Accelerator-KV260`
...
.. admonition:: Last verified against
   ...
   Commit ``<SHA>`` @ ``hwkim-dev/NPU-FPGA-Transformer-Accelerator-KV260``
   (YYYY-MM-DD)
```
